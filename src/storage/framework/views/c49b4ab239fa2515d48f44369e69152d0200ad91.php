    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
            ...
            <div class="ml-4 text-center text-sm text-gray-500 sm:text-right sm:ml-0">
                Laravel v<?php echo e(Boot\Foundation\App::VERSION); ?> (PHP v<?php echo e(PHP_VERSION); ?>)
            </div>
        </div>
    </div>
</div>
...
<?php /**PATH /home/assane/dev-doc/web-apps/framework/src/resources/views/layouts/app/app.blade.php ENDPATH**/ ?>